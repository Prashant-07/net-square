...
from object_factory import UserObjectFactory
import re, sys
...
class FareController:
    ...
    def process_ledger(self):
        try:
            ...
            print(f"Unable to proceed further due to the exception : {e}")
    ...
    def get_final_billing(self, sorted_usernames = False):
        ...
        for username in usernames:
            ...
            print(f"{user.name} {user.sessions} {user.total_duration}")
...
if __name__ == '__main__':
    ...
    fare_controller.process_ledger()
    fare_controller.get_final_billing()